...
if ($conexion->connect_error) {
  ...
  //$a = mysqli_query($conexion, $sql);
    ...
    $sql = "SELECT * FROM bd_botes WHERE ID_BOTE = '$id_consulta' OR FECHA= '$fecha' ";
  //$a = mysqli_query($conexion, $sql);
    $result = mysqli_query($conexion, $sql);
  }
  //-----Cerrar-bd
  ...
  <nav class="navbar navbar-expand-md fixed-top bg-dark navbar-dark">
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-center" id="navbar2SupportedContent">
        ...
        <form action="capturar_datos_botes_admin.php" method="post">
          <ul class="navbar-nav">
            <!-- Visualización de ingreso de id bote, botón ingresar bote, logo de la empresa -->
            <li class="nav-item mx-2">
              <input type="text" class="form-control btn-lg" placeholder="Ingrese código del bote" name="id_bote" required="">
            </li>
            <li class="nav-item mx-2">
              <!-- <button type="submit" class="btn btn-primary bg-dark btn-block">Registrarse</button> -->
    ...
    <div class="container" style="	background-image: linear-gradient(to bottom, rgba(0,0,0,0.7), rgba(0,0,0,0.8));	background-position: top left;	background-size: 100%;	background-repeat: repeat;">
      <div class="row" style="">
        <div class="col-lg-12 text-white mt-5" style="">
          <h1 class="d-none d-md-block text-center text-capitalize text-light" style=""><b>Administrador de botes interactivos Cali (Botes)</b></h1>
          <!-- Navegador para busquedas de botes para habilitar, deshabilitar(eliminar) -->
          <form action="botes_admin.php" method="post">
          ...
          <form action="desactivar_bote.php" method="post">
